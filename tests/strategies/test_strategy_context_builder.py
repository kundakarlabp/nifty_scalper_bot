...
def test_existing_strategy_entry_points_use_canonical_builder() -> None:
    assert signal_generator.build_strategy_history_context is build_strategy_history_context
