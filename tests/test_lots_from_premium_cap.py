...
from src.risk.position_sizing import PositionSizer, SizingBlock, lots_from_premium_cap
...
def test_lots_from_premium_cap_equity_sufficient(monkeypatch):
    ...
    price = 112.8
    lot_size = 75
    lots, unit, cap, eq_source, block = lots_from_premium_cap(
...
def test_lots_from_premium_cap_fallbacks_to_default_equity(monkeypatch):
    ...
    lots, _, cap, eq_source, block = lots_from_premium_cap(
