...
from nifty_scalper_bot.execution import adaptive_trailing, adaptive_trailing_core
...
def test_adaptive_controller_identity_is_stable() -> None:
    ...
    assert issubclass(controller, adaptive_trailing_core.AdaptiveTrailingController)
    assert adaptive_trailing.TrailingSpec is adaptive_trailing_core.TrailingSpec
