...
def test_daily_report_calibrates_independent_alpha_components_by_strategy_and_regime() -> None:
    module = _load_daily_report_module()
    trades = [
        {
    ...
    assert "| ORBPro | TREND | alpha_score | 8.0–<9.0 | 2 | 50.0% | 100.0 | 3.0 | 100.0 |" in report
