...
def main() -> None:
    ...
    ap.add_argument("--write-env", action="store_true", help="Write ZERODHA_ACCESS_TOKEN into .env")
    ...
    api_secret = os.getenv("ZERODHA_API_SECRET") or getpass("ZERODHA_API_SECRET (hidden): ").strip()
