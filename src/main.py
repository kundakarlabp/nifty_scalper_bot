...
# Optional import: avoid import-time crash if kiteconnect not installed
try:
...
class Application:
    ...
    def __init__(self):
        ...
        if KiteConnect is None:
            logger.critical("kiteconnect is not installed. Install with: pip install kiteconnect")
            sys.exit(1)
        try:
    ...
    def control_bot(self, command: str, value: str) -> bool:
        # Implement start/stop/mode controls as needed
