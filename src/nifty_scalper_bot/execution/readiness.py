...
_READINESS_PRIORITY = [
    ...
    "outside_session",
    "broker_health_block",
    "futures_history_short",
    "futures_history_gap",
    "futures_latest_closed_bar_stale",
...
_BLOCKER_ALIASES = {
    ...
    "selected_ce_runner_delivery_missing": "selected_option_runner_delivery_missing",
    "selected_pe_runner_delivery_missing": "selected_option_runner_delivery_missing",
