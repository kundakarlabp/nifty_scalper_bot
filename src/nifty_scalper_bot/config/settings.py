...
USE_REGIME_ADAPTIVE = _env_bool("USE_REGIME_ADAPTIVE", default=True)
MICROVOL_PERCENTILE = _env_float("MICROVOL_PERCENTILE", default=60.0, minimum=0.0)
ADAPTIVE_WINDOW_TRADES = _env_int("ADAPTIVE_WINDOW_TRADES", default=200, minimum=1)
ADAPTIVE_RECALIBRATE_EVERY = _env_int(
    "ADAPTIVE_RECALIBRATE_EVERY", default=50, minimum=1
)
...
SIGNAL_WEIGHT_DEPTH = _env_float("SIGNAL_WEIGHT_DEPTH", default=0.4)
SIGNAL_WEIGHT_SPREAD = _env_float("SIGNAL_WEIGHT_SPREAD", default=1.1)
...
__all__ = [
    ...
    "ADAPTIVE_RECALIBRATE_EVERY",
    "MAX_KELLY_FRACTION",
    "REGIME_FALLBACK_SCALE",
    "ALLOW_AFTER_MARKET_STREAMING",
    "MIN_REGIME_HISTORY",
    "SIGNAL_WEIGHT_MOMENTUM",
    "SIGNAL_WEIGHT_VOL",
    "SIGNAL_WEIGHT_DEPTH",
    "SIGNAL_WEIGHT_SPREAD",
]
