...
class StrikeSelector:
    ...
    def select_contract(
        ...
        **_: Any,
        ...
        """Select an option contract for the provided underlying.

        Args:
            underlying: Base symbol being traded.
            side: Trade direction expressed as BUY/SELL signal.
            option_type: Preferred option type token (CE/PE).
            underlying_price: Latest traded price of the underlying.
