    ...
    def diagnose(self) -> Dict[str, Any]:
        ...
        try:
            if not spot_df.empty:
                ...
                checks.append({"name": "indicators", "ok": False})
        except Exception as e:
        ...
        try:
            if not opt_df.empty and not spot_df.empty:
                ...
                signal_ok = bool(sig)
                checks.append({"name": "signal", "ok": signal_ok, "value": sig})
            else:
